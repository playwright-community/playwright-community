...
**Note**: To easier find out the executable path of the browsers, you can open the version page of the related browser. These would be `edge://version`, `chrome://version` or `brave://version` depending your browser. On this special site, you'll find the correct executable path if you have a GUI installed.
