export const meta = {
  ...
  description: "Overview and setup guide for tracking and visualizing the JavaScript test coverage of your end-to-end tests.",
  author: "Max Schmitt",
  date: "2020-06-23",
...
In this tutorial, we went through the setup which is required to configure Playwright for storing and merging the coverage data of your End-to-End tests. You'll find the full repository [on GitHub](https://github.com/playwright-community/playwright-jest-examples/tree/master/create-react-app-coverage) as a reference on GitHub.
