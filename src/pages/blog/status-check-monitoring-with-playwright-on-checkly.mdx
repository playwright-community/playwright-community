...
We're looking forward to how Checkly will make their monitoring solution even more accessible for developers with e.g. versioned code, an integrated Monaco editor with better auto-completion, or support for custom NPM modules. We would recommend giving it a try and have not to worry about where to run your status checks or end-to-end tests and benefit from simplicity.
