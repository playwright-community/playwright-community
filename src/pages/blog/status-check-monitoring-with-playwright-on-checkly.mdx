...
To fix these issues, Checkly has created a product to provide developer-friendly status checks, which can be used to launch browsers in the cloud. By using it you also don't need to spin up an own instance in your infrastructure since Checkly is a SaaS (Software as a Service) product and they host it for you. They even provide a full public dashboard for your customers.
...
- using a search on your website to ensure your elastic search in the background is correctly configured and holds the expected data
...
<img src="/blog/status-check-monitoring-with-playwright-on-checkly/github-pr.png" style={{maxWidth: 500}}/>
...
For more information, see on [checklyhq.com](https://www.checklyhq.com).