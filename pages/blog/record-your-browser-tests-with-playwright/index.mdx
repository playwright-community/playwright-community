export const meta = {
  ...
  description: "Deep dive into how you record a Chromium browser with playwright-video and upload the recording on GitHub Actions when it fails.",
  author: "Max Schmitt",
  date: "2020-06-3",
...
<video style={{maxHeight: 500}} controls muted autoPlay loop>
