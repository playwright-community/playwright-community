...
The concept needs to be integrated into two parts of your application. The main layout or component that renders your pages needs to reference to your AWS Lambda function path. Due to the requirement of Twitter, that they need a full URL, we have to prefix the path with it.
...
<img src="/blog/generate-opengraph-images-using-playwright/example-card.png" style={{maxWidth: 500}}/>
